...
{  
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD, ENABLE);  // USART2 remapping용 GPIOD
...
void GPIO_Configure(void)
{
    ...
    /* USART2 Remapping 활성화 
     * - 기본 핀 PA2/PA3에서 PD5/PD6으로 변경
     * - PA3에 부저가 연결되어 있어 충돌 방지 */
    GPIO_PinRemapConfig(GPIO_Remap_USART2, ENABLE);
    
    /* USART2 pin setting (Remapped to PD5, PD6) */
    //TX (PD5)
